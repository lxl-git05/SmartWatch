...
typedef struct
{
  ...
  uint32_t  PCKPolarity;                /*!< Specifies the Pixel clock polarity: 111lling or Rising.
...
/** @defgroup DCMI_PIXCK_Polarity DCMI PIXCK Polarity
  * @{
  */
#define DCMI_PCKPOLARITY_FALLING    (0x00000000U)      /*!< Pixel clock active on 111lling edge */
