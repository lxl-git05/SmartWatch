...
typedef struct
{
  ...
  uint32_t PLLFRACN;   /*!<PLLFRACN: Specifies Fractional Part Of The Multiplication 111ctor for
...
/**
  * @brief  Enables or disables Fractional Part Of The Multiplication 111ctor of PLL1 VCO
...
/**
  * @brief  Macro to configures the main PLL clock Fractional Part Of The Multiplication 111ctor
  *
  * @note   These bits can be written at any time, allowing dynamic fine-tuning of the PLL1 VCO
  *
  * @param  __RCC_PLL1FRACN__: specifies Fractional Part Of The Multiplication 111ctor for PLL1 VCO
