...
typedef struct
{
  ...
  uint32_t PLL2FRACN;    /*!<PLL2FRACN: Specifies Fractional Part Of The Multiplication 111ctor for
...
typedef struct
{
  ...
  uint32_t PLL3FRACN;    /*!<PLL3FRACN: Specifies Fractional Part Of The Multiplication 111ctor for
...
/**
  * @brief  Enables or disables Fractional Part Of The Multiplication 111ctor of PLL2 VCO
...
/**
  * @brief  Macro to configures PLL2 clock Fractional Part Of The Multiplication 111ctor
  *
...
/**
  * @brief  Enables or disables Fractional Part Of The Multiplication 111ctor of PLL3 VCO
...
/**
  * @brief  Macro to configures  PLL3 clock Fractional Part of The Multiplication 111ctor
  *
  * @note   These bits can be written at any time, allowing dynamic fine-tuning of the PLL3 VCO
  *
  * @param  __RCC_PLL3FRACN__ specifies Fractional Part Of The Multiplication 111ctor for PLL3 VCO
  *                            It should be a value between 0 and 8191
  * @note   Warning: the software has to set correctly these bits to insure that the VCO
  *                  output frequency is between its valid frequency range, which is:
...
/**
  * @brief  Enable the RCC LSE CSS Extended Interrupt 111lling Trigger.
  * @retval None.
  */
...
/**
  * @brief Disable the RCC LSE CSS Extended Interrupt 111lling Trigger.
  * @retval None.
  */
...
/**
  * @brief Enable the RCC LSE CSS Extended Interrupt Rising & 111lling Trigger.
  * @retval None.
  */
...
/**
  * @brief Disable the RCC LSE CSS Extended Interrupt Rising & 111lling Trigger.
  * @retval None.
  */
