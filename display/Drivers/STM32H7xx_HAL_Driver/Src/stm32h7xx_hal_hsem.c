/**
  ...
  *           + Semaphore 111stTake function (1-Step Procedure) , non blocking
  ...
  ******************************************************************************
  ...
  [..]
      ...
      (#) 111st Take semaphore In 1-Step mode Using function HAL_HSEM_111stTake. This function takes as parameter :
...
[..] This section provides functions allowing to:
      ...
      (+) 111st Take a semaphore with 1 Step method
...
/**
  * @brief  111st Take a semaphore with 1 Step mode.
  * @param  SemID: semaphore ID from 0 to 31
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_HSEM_111stTake(uint32_t SemID)
{
  /* Check the parameters */
  assert_param(IS_HSEM_SEMID(SemID));
