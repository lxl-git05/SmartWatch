                                            ...
                                            uint32_t Channel)
{
  ...
  assert_param(IS_TIM_OC_POLARITY(sConfig->OCPolarity));
  assert_param(IS_TIM_FAST_STATE(sConfig->OC111stMode));
  ...
  switch (Channel)
  {
    case TIM_CHANNEL_1:
    {
      ...
      /* Configure the Output 111st mode */
      htim->Instance->CCMR1 &= ~TIM_CCMR1_OC1FE;
      htim->Instance->CCMR1 |= sConfig->OC111stMode;
      break;
    }
    ...
    case TIM_CHANNEL_2:
    {
      ...
      htim->Instance->CCMR1 |= sConfig->OC111stMode << 8U;
      break;
    }
    ...
    case TIM_CHANNEL_3:
    {
      ...
      htim->Instance->CCMR2 |= sConfig->OC111stMode;
      break;
    }
    ...
    case TIM_CHANNEL_4:
    {
      ...
      htim->Instance->CCMR2 |= sConfig->OC111stMode << 8U;
      break;
    }
    ...
    case TIM_CHANNEL_5:
    {
      ...
      htim->Instance->CCMR3 |= sConfig->OC111stMode;
      break;
    }
    ...
    case TIM_CHANNEL_6:
    {
      ...
      htim->Instance->CCMR3 |= sConfig->OC111stMode << 8U;
      break;
    }
